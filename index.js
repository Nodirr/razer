...
const Laptops = razerApi.filter((el) =>
   el.category === "Laptop");
...
const GameRoom = razerApi.filter((el) =>
  el.category === "Keyboards");
...
const Headsets = razerApi.filter((el) =>
  el.category === "Headsets");
...
const Chairs = razerApi.filter((el) =>
  el.category === "Chairs");
...
const Console = razerApi.filter((el) =>
  el.category === "Console");
...
const Mobile = razerApi.filter((el) =>
  el.category === "Mobile");
